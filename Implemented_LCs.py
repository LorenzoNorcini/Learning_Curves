...
MNB_train_size, train_scores, test_scores = \
    lc.Learning_Curve(clfMNB, cv_iter, data, labels, train_sizes)       # Gets Learning Curve data for MultinomialNB
...
BNB_train_size, train_scores, test_scores = \
    lc.Learning_Curve(clfBNB, cv_iter, data, labels, train_sizes)       # Gets Learning Curve data for BernoulliNB
...
Per_train_size, train_scores, test_scores = \
    lc.Learning_Curve(clfPer, cv_iter, data, labels, train_sizes)       # Gets Learning Curve data for Perceptron
